...
trait Messages
{
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    protected function jsonErrorResourceNotFound($message = '')
    {
        if (empty($message)) {
    ...
    {
        return response()->stream($this->downloadCallback($decrypted_file), $code, [
                'Content-type' => $headers['content_type'],
                'Content-Disposition' => 'inline; filename='. $headers['filename'],
            ]
        );
    }
